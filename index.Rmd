...
The report can be accessed [click here](https://github.com/cindyellow/JSC370-FinalProject/blob/master/JSC370_FinalProject_Report_Shih-Ting(Cindy)Huang.pdf).

A video presentation which explains this study can be seen [here](https://youtube.com).
